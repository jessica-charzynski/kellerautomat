...
var arrayKorrekt = ["1","3","(0)","(5)","1+1","7*8","9-6","(3-2)","(5*5)","4+(2)","8*(0)","((7))","((8))","7+5-3","3*2+1","(9)-1","7/(1)","4-(5+4)","5*(2/1)"];
...
var arrayFalsch = ["(","+","*","22","7-","1++","2+(","3-()","(9/3","((1)","4*10","8*5/","3*3+)","0+((1","(1+2+","6-2++","2*(3-2","1+(5/1"];
